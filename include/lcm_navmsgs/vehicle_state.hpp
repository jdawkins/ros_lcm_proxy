...
#ifndef __lcm_navmsgs_vehicle_state_hpp__
#define __lcm_navmsgs_vehicle_state_hpp__
...
int vehicle_state::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int vehicle_state::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int vehicle_state::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t vehicle_state::getHash()
{
    static int64_t hash = _computeHash(NULL);
    return hash;
}

const char* vehicle_state::getTypeName()
{
    return "vehicle_state";
}

int vehicle_state::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int vehicle_state::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int vehicle_state::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t vehicle_state::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0x34200f922f5af675LL;
